...
pub mod exports {
    pub mod theater {
        pub mod simple {
            /// Actor interface that all Theater actors must implement.
            #[allow(dead_code, async_fn_in_trait, unused_imports, clippy::all)]
            pub mod actor {
                #[used]
                #[doc(hidden)]
                ...
                pub trait Guest {
                    /// Initialize the actor with optional initial state.
                    fn init(
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_wasi_io_test_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_wasi_io_test_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:test:wasi-io@0.1.0:wasi-io-test:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1395] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf0\x09\x01A\x02\x01\
...
\x18\x03\0\x15wasi:io/streams@0.2.3\x05\x04\x01B\x07\x01p}\x01k\0\x01o\x01s\x01o\
\x01\x01\x01j\x01\x03\x01s\x01@\x02\x05state\x01\x06params\x02\0\x04\x04\0\x04in\
it\x01\x05\x04\0\x14theater:simple/actor\x05\x05\x04\0\x1ftest:wasi-io/wasi-io-t\
est@0.1.0\x04\0\x0b\x12\x01\0\x0cwasi-io-test\x03\0\0\0G\x09producers\x01\x0cpro\
