...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_wasi_filesystem_test_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_wasi_filesystem_test_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:test:wasi-filesystem:wasi-filesystem-test:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4780] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa1$\x01A\x02\x01A\x15\
...
\x18\x03\0\x15wasi:io/streams@0.2.3\x05\x04\x01B\x05\x01r\x02\x07secondsw\x0bnan\
osecondsy\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0ar\
esolution\x01\x02\x03\0\x1cwasi:clocks/wall-clock@0.2.3\x05\x05\x02\x03\0\x02\x0c\
...
\x0c\x01B\x07\x01p}\x01k\0\x01o\x01s\x01o\x01\x01\x01j\x01\x03\x01s\x01@\x02\x05\
state\x01\x06params\x02\0\x04\x04\0\x04init\x01\x05\x04\0\x14theater:simple/acto\
r\x05\x0d\x04\0)test:wasi-filesystem/wasi-filesystem-test\x04\0\x0b\x1a\x01\0\x14\
wasi-filesystem-test\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-comp\
