...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_wasi_http_test_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_wasi_http_test_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:test:wasi-http@0.2.0:wasi-http-test:encoded world"
)]
#[doc(hidden)]
