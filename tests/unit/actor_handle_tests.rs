...
async fn test_get_metrics() {
    ...
    // Verify key metrics
    assert_eq!(
        result.operation_metrics.total_operations,
        test_metrics.operation_metrics.total_operations
    );
    assert_eq!(
        result.resource_metrics.memory_usage,
        test_metrics.resource_metrics.memory_usage
    );
